  ...
  return (
    ...
    >
      ...
      <section className="mb-12">
        ...
        <p>
          Blockchain technology fundamentally changes this dynamic. As the underlying technology records all transactions on a <strong>public, immutable ledger</strong>, every deposit, withdrawal, and bet settlement becomes visible to anyone who knows where to look. <a href="https://en.wikipedia.org/wiki/Blockchain" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Blockchain's core properties</a>—immutability, transparency, and decentralization—mean that once a transaction is recorded, it cannot be altered or hidden. Smart contract casinos extend this transparency further by making their entire game logic publicly auditable through <a href="https://en.wikipedia.org/wiki/Smart_contract" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">verified contract code</a>.
        </p>
      </section>
