      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-sm font-medium text-primary">DEGEN CULTURE</span>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            ...
            <span className="block text-gradient">
              and Wallet-First Gambling
            </span>
          </h1>

          {/* Subtitle */}
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Exploring how degens think, play, and talk about crypto casinos without rankings, 
            endorsements, or official claims.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            >
              <a href="#latest-blog">Explore the Culture</a>
            </Button>
            <Button 
              variant="outline" 
              size="lg" 
